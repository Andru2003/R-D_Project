...
import com.example.rdproject.Models.ExtendedIngredient;
...
public class IngredientsAdapter extends RecyclerView.Adapter<IngredientsViewHolder> {
    ...
    public void onBindViewHolder(@NonNull IngredientsViewHolder holder, int position) {
        ...
        Picasso.get().load("https://spoonacular.com/cdn/ingredients_100x100/" + list.get(position).image).resize(250, 250).into(holder.imageView_ingredients);
    }
